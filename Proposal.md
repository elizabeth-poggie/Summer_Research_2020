...
These are some visually appealing libraries that I can incorporate to add the user experience because a huge issue with a lot of these mental health applications is that they are not interactive. Some just show the user a video clip or just give quizzes. Some examples of libraries are: 
- Three.js can be used to create and display interactive animated 3D graphics. 
- p5.js is used for creative coding and making simple animations. 
- D3.js can be used for manipulating documents based on data. Not sure how this can fit into the application but might have some insights after exploring all these other applications that already exist. 
