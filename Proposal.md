...
My goal is to develop a good opensource application for panic mitigation. 
...
Cambridge found some examples of computerized therapy for depression and anxiety in 2018 that led to greater satisfaction with treatment long afterwards. They ran their study on the efficacy with the web application “Beating the Blues” which is an interactive CBT package and 8 therapy sessions lasting 50 minutes. The general way for how the program works can be found on their website as well as many papers published about the efficacy of this online treatment. Additionally, McGill recommends a selection of IOS and Android applications for targeting depression or anxiety. 

I can investigate the overlap that “Beating the Blues” has with the McGill recommended applications in order to create something with the pest possible user experience while also ensuring that the choices of tasks for the application have been proven to be clinically effective. 

It also should be noted that the McGill recommended applications are all free whereas Beating the Blues is 100 euros (153 CAD). They have recently discounted the application since Covid-19 to be 20 euros (31 CAD). 

## What I’m doing this Weekend

Downloading every recommended application for panic, depression, and anxiety and comparing their similarities, strengths, and downsides while ensuring all the tasks they are being used are clinically significant. As well, I need to investigate other tasks that are proven successful but are not apparent in any of these applications. 

Total potential cost: 50 CAD

## Software I will use

React native as this is compatible with IOS and Android so getting help is not dependent on the operating system.


## Research tools 

JSTOR and Google Scholar are my best friends right now. As well as all the reviews on the App and Play store. 
...
Wek 17: August 10 – August 14:
The summer semester examination period is this week. Submit code and final report.  


## Goal

To make a functional opensource application for panic mitigation. 


## Future Work

Just because all the tasks I am looking at are clinically significant, this does not mean 
